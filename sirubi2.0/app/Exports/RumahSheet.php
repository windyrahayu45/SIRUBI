    ...
    WithEvents
{
     ...
     * FIX PENTING:
     * - Hapus offset/limit
     * - Jangan chunk manual di sini
     * - WithChunkReading akan otomatis handle
     */
    public function query()
    {
        $base = $this->query ?? Rumah::query();
        ...
        return $base
            ...
            ->with([
                ...
                'sanitasi.jamban:id_jamban,jamban','sanitasi.kondisiJamban:id_kondisi_jamban,kondisi_jamban',
    ...
    {
        // mapping sama seperti punya kamu
        return [
            $r->id_rumah,
            $r->alamat,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $s->setCellValue('W4', 'Aspek Keselamatan');
                $s->setCellValue('AE4', 'Aspek Kesehatan');
                $s->setCellValue('AU4', 'Aspek Luas & Ruang');
                $s->setCellValue('BG4', 'Komponen Bangunan');
                $s->setCellValue('BR4', 'Penilaian Akhir');

                $s->mergeCells('A4:V4');
                $s->mergeCells('W4:AD4');
                $s->mergeCells('AE4:AT4');
                $s->mergeCells('AU4:BF4');
                $s->mergeCells('BG4:BR4');
                $s->mergeCells('BS4:BV4');
