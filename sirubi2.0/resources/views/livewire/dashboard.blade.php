            ...
            <div class="row g-5 g-xl-8 mt-5">
                <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-7">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-800">Grafik Pengunjung</span>
                                <span class="text-gray-400 mt-1 fw-semibold fs-6">Data pengunjung aplikasi</span>
                            </h3>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                                <!--begin::Daterangepicker(defined in src/js/layout/app.js)-->
                                <div   id="visitor_range_picker" data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left" class="btn btn-sm btn-light d-flex align-items-center px-4">
                                    <!--begin::Display range-->
                                    <div class="text-gray-600 fw-bold" id="visitor_range_display">Loading date range...</div>
                                    <!--end::Display range-->
                        ...
                        <div class="card-body d-flex align-items-end px-0 pt-3 pb-5">
                            <!--begin::Chart-->
                            <div id="visit_chart" wire:ignore class="h-325px w-100 min-h-auto ps-4 pe-6"></div>
                            <!--end::Chart-->
                        </div>
                        <!--end: Card Body-->
                    </div>
...
document.addEventListener("livewire:init", () => {
    ...
    function renderChart(labels, data) {
        ...
        chart = new ApexCharts(document.querySelector("#visit_chart"), {
            chart: {
                type: "area",
                height: 325,
                toolbar: { show: false }
   ...
   Livewire.on('updateChart', ({ labels, data }) => {
    ...
    let el = document.querySelector("#visit_chart");
    if (!el) return setTimeout(initVisitorChart, 200);
...
<!-- Metronic Daterangepicker Handler -->
<script>
document.addEventListener("DOMContentLoaded", function () {

    let display = document.querySelector("#visitor_range_display");
    let picker = $("#visitor_range_picker");
