...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Sistem Perumahan Kota Bukittinggi "
    />
    <meta name="keywords" content="company" />
    <meta
      name="twitter:title"
      content="SIRUBI | Sistem Perumahan Kota Bukittinggi"
    />
    <meta
    ...
    <!-- Page title -->
    <title>SIRUBI | Sistem Perumahan Kota Bukittinggi</title>
          ...
          <div class="grid grid-cols-1 gap-14 lg:grid-cols-2">
            <div class="w-full">
              <figure class="scroll-revealed max-w-[480px] mx-auto">
                <img
                  src="{{ asset('landing/assets/img/about-img.jpg') }}"
                  alt="About image"
                  class="rounded-xl"
                />
              </figure>
          ...
          <div class="scroll-revealed portfolio-grid row">
            <div class="portfolio col-12 sm:col-6 lg:col-4">
              <article class="group" data-filter="branding">
                ...
                >
                  <img
                    src="{{ asset('landing/assets/img/portfolio/portfolio-1.jpg') }}"
                    alt="Graphics Design"
                  ...
                  >
                    <div class="flex flex-wrap gap-2 p-4">
                      <div class="inline-block relative">
                        <a
                          href="{{ asset('landing/assets/img/portfolio/portfolio-1.jpg') }}"
            ...
            <div class="portfolio col-12 sm:col-6 lg:col-4">
              <article class="group" data-filter="research">
                ...
                >
                  <img
                    src="{{ asset('landing/assets/img/portfolio/portfolio-2.jpg') }}"
                    alt="Web Development"
                    class="w-full h-full object-cover"
                  />
                  <div
                  ...
                  >
                    <div class="flex flex-wrap gap-2 p-4">
                      <div class="inline-block relative">
                        <a
                          href="{{ asset('landing/assets/img/portfolio/portfolio-2.jpg') }}"
                          class="portfolio-box text-[1.75rem] text-primary-color bg-primary z-10 w-[60px] aspect-square rounded-lg text-center inline-flex items-center justify-center hover:bg-primary-light-10 hover:text-primary-color dark:hover:bg-primary-dark-10 dark:hover:text-primary-color focus:bg-primary-light-10 focus:text-primary-color dark:focus:bg-primary-dark-10 dark:focus:text-primary-color"
                        >
                          <i class="lni lni-zoom-in"></i>
                        </a>
            ...
            <div class="portfolio col-12 sm:col-6 lg:col-4">
              <article class="group" data-filter="marketing">
                ...
                >
                  <img
                    src="{{ asset('landing/assets/img/portfolio/portfolio-3.jpg') }}"
                    alt="App Development"
                    class="w-full h-full object-cover"
                  />
                  <div
                  ...
                  >
                    <div class="flex flex-wrap gap-2 p-4">
                      <div class="inline-block relative">
                        <a
                          href="{{ asset('landing/assets/img/portfolio/portfolio-3.jpg') }}"
                          class="portfolio-box text-[1.75rem] text-primary-color bg-primary z-10 w-[60px] aspect-square rounded-lg text-center inline-flex items-center justify-center hover:bg-primary-light-10 hover:text-primary-color dark:hover:bg-primary-dark-10 dark:hover:text-primary-color focus:bg-primary-light-10 focus:text-primary-color dark:focus:bg-primary-dark-10 dark:focus:text-primary-color"
                        >
                          <i class="lni lni-zoom-in"></i>
                        </a>
            ...
            <div class="portfolio col-12 sm:col-6 lg:col-4">
              <article class="group" data-filter="planning">
                ...
                >
                  <img
                    src="{{ asset('landing/assets/img/portfolio/portfolio-4.jpg') }}"
                  ...
                  >
                    <div class="flex flex-wrap gap-2 p-4">
                      <div class="inline-block relative">
                        <a
                          href="{{ asset('landing/assets/img/portfolio/portfolio-4.jpg') }}"
                          class="portfolio-box text-[1.75rem] text-primary-color bg-primary z-10 w-[60px] aspect-square rounded-lg text-center inline-flex items-center justify-center hover:bg-primary-light-10 hover:text-primary-color dark:hover:bg-primary-dark-10 dark:hover:text-primary-color focus:bg-primary-light-10 focus:text-primary-color dark:focus:bg-primary-dark-10 dark:focus:text-primary-color"
                        >
                          <i class="lni lni-zoom-in"></i>
                        </a>
            ...
            <div class="portfolio col-12 sm:col-6 lg:col-4">
              <article class="group" data-filter="branding">
                ...
                >
                  <img
                    src="{{ asset('landing/assets/img/portfolio/portfolio-5.jpg') }}"
                    alt="SEO Services"
                    class="w-full h-full object-cover"
                  />
                  <div
                  ...
                  >
                    <div class="flex flex-wrap gap-2 p-4">
                      <div class="inline-block relative">
                        <a
                          href="{{ asset('landing/assets/img/portfolio/portfolio-5.jpg') }}"
                          class="portfolio-box text-[1.75rem] text-primary-color bg-primary z-10 w-[60px] aspect-square rounded-lg text-center inline-flex items-center justify-center hover:bg-primary-light-10 hover:text-primary-color dark:hover:bg-primary-dark-10 dark:hover:text-primary-color focus:bg-primary-light-10 focus:text-primary-color dark:focus:bg-primary-dark-10 dark:focus:text-primary-color"
                        >
                          <i class="lni lni-zoom-in"></i>
                        </a>
            ...
            <div class="portfolio col-12 sm:col-6 lg:col-4">
              <article class="group" data-filter="marketing">
                ...
                >
                  <img
                    src="{{ asset('landing/assets/img/portfolio/portfolio-6.jpg') }}"
                    alt="Product Design"
                    class="w-full h-full object-cover"
                  />
                  <div
                  ...
                  >
                    <div class="flex flex-wrap gap-2 p-4">
                      <div class="inline-block relative">
                        <a
                          href="{{ asset('landing/assets/img/portfolio/portfolio-6.jpg') }}"
                          class="portfolio-box text-[1.75rem] text-primary-color bg-primary z-10 w-[60px] aspect-square rounded-lg text-center inline-flex items-center justify-center hover:bg-primary-light-10 hover:text-primary-color dark:hover:bg-primary-dark-10 dark:hover:text-primary-color focus:bg-primary-light-10 focus:text-primary-color dark:focus:bg-primary-dark-10 dark:focus:text-primary-color"
                        >
                          <i class="lni lni-zoom-in"></i>
                        </a>
          ...
          <div class="row">
            <div class="scroll-revealed col-12 sm:col-6 md:col-4 lg:col-3">
              ...
              >
                <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                  <img
                    src="{{ asset('landing/assets/img/avatar/avatar-1.jpg') }}"
                    alt="Team picture"
            ...
            <div class="scroll-revealed col-12 sm:col-6 md:col-4 lg:col-3">
              ...
              >
                <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                  <img
                    src="{{ asset('landing/assets/img/avatar/avatar-2.jpg') }}"
                    alt="Team picture"
                    class="h-full w-full rounded-full object-cover"
                  />
                  <span
            ...
            <div class="scroll-revealed col-12 sm:col-6 md:col-4 lg:col-3">
              ...
              >
                <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                  <img
                    src="{{ asset('landing/assets/img/avatar/avatar-3.jpg') }}"
                    alt="Team picture"
                    class="h-full w-full rounded-full object-cover"
                  />
                  <span
                ...
                >
                  ...
                  <figure class="flex items-center gap-4">
                    <div class="h-[50px] w-[50px] overflow-hidden">
                      <img
                        src="{{ asset('landing/assets/img/avatar/avatar-4.jpg') }}"
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <figure class="flex items-center gap-4">
                    <div class="h-[50px] w-[50px] overflow-hidden">
                      <img
                        src="{{ asset('landing/assets/img/avatar/avatar-5.jpg') }}"
                        alt="Testimonial picture"
                        class="h-full w-full rounded-full object-cover"
                      />
                    </div>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <figure class="flex items-center gap-4">
                    <div class="h-[50px] w-[50px] overflow-hidden">
                      <img
                        src="{{ asset('landing/assets/img/avatar/avatar-6.jpg') }}"
                        alt="Testimonial picture"
                        class="h-full w-full rounded-full object-cover"
                      />
                    </div>
              ...
              <div class="swiper-slide">
                ...
                >
                  ...
                  <figure class="flex items-center gap-4">
                    <div class="h-[50px] w-[50px] overflow-hidden">
                      <img
                        src="{{ asset('landing/assets/img/avatar/avatar-7.jpg') }}"
                        alt="Testimonial picture"
                        class="h-full w-full rounded-full object-cover"
                      />
                    </div>
            ...
            <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
              <article class="group">
                <div class="relative">
                  ...
                  >
                    <img
                      src="{{ asset('landing/assets/img/thumbnail/thumbnail-1.jpg') }}"
                      alt="Thumbnail"
            ...
            <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
              <article class="group">
                <div class="relative">
                  ...
                  >
                    <img
                      src="{{ asset('landing/assets/img/thumbnail/thumbnail-2.jpg') }}"
                      alt="Thumbnail"
                      class="w-full h-full object-cover group-hover:scale-[1.05] group-hover:rotate-[2deg]"
                    />
                  </a>
            ...
            <div class="scroll-revealed col-12 sm:col-6 lg:col-4">
              <article class="group">
                <div class="relative">
                  ...
                  >
                    <img
                      src="{{ asset('landing/assets/img/thumbnail/thumbnail-3.jpg') }}"
                      alt="Thumbnail"
                      class="w-full h-full object-cover group-hover:scale-[1.05] group-hover:rotate-[2deg]"
                    />
                  </a>
        ...
        <div class="container">
          ...
          <div class="">
            <div class="row">
              ...
              >
                <img
                  src="{{ asset('landing/assets/img/brand/airbnb.svg') }}"
              ...
              >
                <img
                  src="{{ asset('landing/assets/img/brand/coca-cola.svg') }}"
                  alt="Brand Logo Image"
                  class="h-[40px] inline-block grayscale dark:invert hover:grayscale-0 hover:invert-0"
                />
              </div>
              ...
              >
                <img
                  src="{{ asset('landing/assets/img/brand/facebook.svg') }}"
                  alt="Brand Logo Image"
                  class="h-[40px] inline-block grayscale dark:invert hover:grayscale-0 hover:invert-0"
                />
              </div>
              ...
              >
                <img
                  src="{{ asset('landing/assets/img/brand/mandiri.svg') }}"
                  alt="Brand Logo Image"
                  class="h-[40px] inline-block grayscale dark:invert hover:grayscale-0 hover:invert-0"
                />
              </div>
              ...
              >
                <img
                  src="{{ asset('landing/assets/img/brand/shopware.svg') }}"
                  alt="Brand Logo Image"
                  class="h-[40px] inline-block grayscale dark:invert hover:grayscale-0 hover:invert-0"
                />
              </div>
              ...
              >
                <img
                  src="{{ asset('landing/assets/img/brand/spotify.svg') }}"
                  alt="Brand Logo Image"
                  class="h-[40px] inline-block grayscale dark:invert hover:grayscale-0 hover:invert-0"
                />
              </div>
              ...
              >
                <img
                  src="{{ asset('landing/assets/img/brand/tunnel-id.svg') }}"
                  alt="Brand Logo Image"
                  class="h-[40px] inline-block grayscale dark:invert hover:grayscale-0 hover:invert-0"
                />
              </div>
              ...
              >
                <img
                  src="{{ asset('landing/assets/img/brand/walmart.svg') }}"
                  alt="Brand Logo Image"
                  class="h-[40px] inline-block grayscale dark:invert hover:grayscale-0 hover:invert-0"
                />
              </div>
        ...
        <div class="flex flex-wrap">
          ...
          <div class="w-full md:w-1/2">
            <div class="my-1 flex justify-center md:justify-end">
              <p class="text-body-dark-11">
                &#169; 2024 SIRUBI Inc. All rights reserved. Distributed by <a href="https://themewagon.com" target="_blank">ThemeWagon</a>
              </p>
            </div>
          </div>
        </div>
